...
public class Activity2 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // dino.setImageDrawable();
        //String uri = "@drawable/dino.png";  // where myresource (without the extension) is the file

        //int imageResource = getResources().getIdentifier(uri, null, getPackageName());

        //Drawable res = getResources().getDrawable(imageResource);
       // dino.setImageDrawable(res);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch(event. getAction()){
                ...
                case MotionEvent. ACTION_MOVE : //ACTION_MOVE
                    ...
                    dino.layout(mx,my,mx+v.getWidth(), my+v.getHeight());
